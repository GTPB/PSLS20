...
- We can now approximate the distribution of log transformed direct cholesterol levels using a normal distribution. 
...
- We will have to use the function `exp()` to transform the result back to the direct cholesterol domain. 

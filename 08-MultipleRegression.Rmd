...
- In deze uitdrukking stelt $R_j^2$ de meervoudige determinatieco??ffici??nt voor van een lineaire regressie van de $j$-de predictor op alle andere predictoren in het model. 
...
bodyfat <- read.table("dataset/bodyfat.txt",header=TRUE)
plot(bodyfat)
```

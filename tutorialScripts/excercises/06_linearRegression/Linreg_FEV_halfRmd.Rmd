...
As stated above, the overarching goal of this experiment was to find 
out whether or not smoking has an effect on the FEV of children.
...
For now, we can already answer other (less complex) research questions:

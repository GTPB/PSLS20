...
converted to centimeters usin the `mutate` function. 
...
Should we change legistlations worldwide and make 
smoking obligatory for children?

Maybe there is something else going on in the data.
Now, we will a similar plot, but we will
...
into account more useful explanattory variables with respect
to the FEV?
...
This plot holds one extra level of informattion, the gender 
...
(>175cm), we mainly find male sujects.

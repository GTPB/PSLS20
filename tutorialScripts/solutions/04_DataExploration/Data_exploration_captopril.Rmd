...
Note, that the standard deviation of the blood pressure measurements are more then twice the blood pressure measurements on the difference. 
This is because each patient acts as their own control so we can correct for their baseline blood pressure when estimating the effect of the treatment.
